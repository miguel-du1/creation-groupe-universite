...
$liste_etudiants_par_promo = isset($_GET['promo']) ? Promotion::getListeEtudiantsParPromo($_GET['promo']) : array();
        ...
        <div class="main_content_panel">
            <div class="nav_panel_promo_page">
                ...
                <form action="index.php" methode="GET">
                    <input type="hidden" name="page" value="promotionEtu">
            ...
            <div class="table_content_promotion">
                <?php if (isset($_GET['promo'])): ?>
                    <div class="liste_groupes">
                        <?php 
                            if (!isset($_GET['promo'])) {
                                echo "<p>Veuillez choisir la promotion à rechercher</p>";
                            }
                            ...
                            foreach ($liste_groupes as $groupe) {
                                ...
                                echo "<input type=\"hidden\" name=\"page\" value=\"promotionEtu\">";
                    ...
                    <?php if (isset($_GET['promo'])): ?>
                        <?php 
                            if (isset($_GET['groupe'])) $liste_etudiants_UI = $liste_etudiants_par_groupe;
                            else $liste_etudiants_UI = $liste_etudiants_par_promo;
                        ?>
                        <div class="liste_etudiants_par_groupe">
                            <table>
                                ...
                                <tbody>
                                    <?php 
                                        $compteE = 1;
                                        foreach ($liste_etudiants_UI as $etudiant) {
